...
- **Preview VAP effects inside MP4 files.** Inspect canvas/timing, play with reconstructed transparency, and scrub frames. Dynamic app-supplied overlays are explicitly identified. [Effect previews](docs/effect-resources.md).
