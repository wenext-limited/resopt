...
- **Browse ZIP resource packages.** Search and filter entries, compare stored and expanded sizes, and preview embedded images without extracting files into your project. [Archive limits](docs/archive-resources.md).
