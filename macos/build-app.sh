...
cp "$repo/src/ui/vendor/libpag/LICENSE.txt" "$app/Contents/Resources/THIRD-PARTY-LICENSES-libpag.txt"
cp "$repo/src/ui/vendor/libpag/README.md" "$app/Contents/Resources/LIBPAG-NOTICE.md"
