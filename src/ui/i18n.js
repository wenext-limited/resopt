...
const MESSAGES = {
  en: {
    ...
    cancelling: 'Stopping after the files in progress…', cancelled: 'Analysis was stopped early. Unfinished resources are listed as “Not analyzed”. Run resopt web again to continue; finished work is reused from the cache.',
    ...
    modeCandidates: 'Opportunities', modeWarnings: 'Warnings', modeApplied: 'Applied', modeImages: 'Images', modeUnsupported: 'No optimizer', modeFailed: 'Failed', modeAll: 'All',
    ...
    batch: 'Batch apply…', restoreAll: 'Restore all…', colResource: 'Resource', colSize: 'Original', colSavings: 'Savings',
    ...
    range: '{0}–{1} of {2}', none: '0 resources', previous: 'Previous page', next: 'Next page',
    select: 'Select a resource', selectHint: 'Compare size and quality for each candidate.',
    original: 'Original', candidate: 'Candidate', openFull: 'Open full size ↗', compare: 'Compare at full size', compareTitle: 'Full-size comparison', compareHint: 'Drag the slider, or use ← → keys. Scroll to pan.',
    ...
    lossless: 'lossless', quality: 'quality {0}', allCandidates: 'All candidates', nCandidates: '{0} candidates',
    ...
    applied: 'Applied: {0}. The original is backed up and can be restored.', partial: 'This operation was interrupted. Restore the original to return to a consistent state.',
    ...
    batchScope: 'Only the {0} resources in the current view', batchPreview: 'Preview batch', batchNothing: 'No candidates match this policy.',
    batchSummary: '{0} files · saves {1}\n{2} lossy · {3} with accepted warnings · {4} format changes', batchConfirm: 'Apply {0} files', batchRunning: 'Applied {0} of {1}…', batchStop: 'Stop after current file',
    ...
    restoreAllTitle: 'Restore all applied changes', restoreAllIntro: 'Restores every applied or interrupted operation in this report, newest dependencies first. Files edited afterwards are left untouched and reported.', restoreAllConfirm: 'Restore {0} operations', restoreAllDone: 'Restored {0} · not restored {1}',
  ...
  'zh-CN': {
    ...
    cancelling: '处理完当前文件后停止…', cancelled: '分析已提前停止，未完成的资源标记为“未分析”。再次运行 resopt web 可继续，已完成的结果会从缓存复用。',
    ...
    modeCandidates: '可优化', modeWarnings: '有警告', modeApplied: '已应用', modeImages: '图片', modeUnsupported: '暂无优化器', modeFailed: '失败', modeAll: '全部',
    search: '搜索文件名或路径…', allFormats: '全部格式', sortSavings: '节省量 ↓', sortSize: '原始体积 ↓', sortName: '文件名 A–Z', sortScore: '评分从低到高',
    batch: '批量应用…', restoreAll: '全部恢复…', colResource: '资源', colSize: '原始体积', colSavings: '可节省',
    noMatch: '没有匹配的资源', noMatchHint: '试试其他关键词、格式或视图。', clearFilters: '清除筛选', waiting: '文件分析完成后会陆续显示在这里。',
    range: '{0}–{1} / {2}', none: '0 个资源', previous: '上一页', next: '下一页',
    select: '选择一个资源', selectHint: '对比每个候选的体积与画质。',
    original: '原图', candidate: '候选', openFull: '打开原尺寸 ↗', compare: '原尺寸对比', compareTitle: '原尺寸对比', compareHint: '拖动滑块或使用 ← → 键；滚动可平移。',
    ...
    lossless: '无损', quality: '质量 {0}', allCandidates: '全部方案', nCandidates: '{0} 个方案',
    ...
    applied: '已应用：{0}。原文件已备份，可随时恢复。', partial: '此操作曾被中断。请恢复原图以回到一致状态。',
    ...
    batchScope: '仅当前视图中的 {0} 个资源', batchPreview: '预览批量操作', batchNothing: '没有符合该策略的候选。',
    batchSummary: '{0} 个文件 · 节省 {1}\n{2} 个有损 · {3} 个接受警告 · {4} 个更换格式', batchConfirm: '应用 {0} 个文件', batchRunning: '已应用 {0} / {1}…', batchStop: '处理完当前文件后停止',
    batchDone: '已应用 {0} · 失败 {1} · 跳过 {2} · 节省 {3}', batchFailures: '未应用的文件', batchStopped: '已停止。已应用的文件保持不变，可逐个恢复或使用“全部恢复”。',
    restoreAllTitle: '恢复全部已应用的修改', restoreAllIntro: '恢复此报告中所有已应用或被中断的操作，并按依赖顺序处理。之后被手动修改的文件不会被覆盖，并会列出。', restoreAllConfirm: '恢复 {0} 个操作', restoreAllDone: '已恢复 {0} · 未恢复 {1}',
