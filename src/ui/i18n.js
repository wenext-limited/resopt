...
const MESSAGES = {
  en: {
    ...
    multiSelected: '{0} resources selected', multiSelectedHint: 'Shift-click selects a range; Option/Alt-click toggles individual resources. Batch apply below is limited to this selection.', batchSelected: 'Batch apply {0} selected resources…',
  ...
  'zh-CN': {
    ...
    multiSelected: '已选 {0} 个资源', multiSelectedHint: '按住 Shift 点击选择连续范围；按住 Option/Alt 点击切换单个资源。下方批量应用仅处理这些已选资源。', batchSelected: '批量应用已选的 {0} 个资源…',
