...
const MESSAGES = {
  en: {
    ...
    multiSelected: '{0} resources selected', multiSelectedHint: 'Shift-click selects a range; Option/Alt-click toggles individual resources. The Batch apply button in the toolbar is limited to this selection.', batchSelected: 'Batch apply {0} selected…',
  ...
  'zh-CN': {
    ...
    multiSelected: '已选 {0} 个资源', multiSelectedHint: '按住 Shift 点击选择连续范围；按住 Option/Alt 点击切换单个资源。工具栏中的“批量应用”仅处理这些已选资源。', batchSelected: '批量应用已选 {0} 个…',
